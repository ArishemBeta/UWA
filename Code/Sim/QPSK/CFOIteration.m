 function cfo_iter=CFOIteration(al,ah,P,u,v,sc_idx,Nt,Nr,Ns,K,L,RX_block,pilot_symbol,block_symbol)
% E=0.1;
% maxnum=5;%最大迭代次数
% narvs=1;%目标函数的自变量个数
...
BER_cost=0;    
BER_cost=BER_cost_d_calculation(RX_block,0,al,Nt,Nr,block_symbol,Ns,K,L,sc_idx,pilot_symbol);
...
while(1)
    ...
    BER_cost_d=BER_cost_d_calculation(RX_block,delta,a,Nt,Nr,block_symbol,Ns,K,L,sc_idx,pilot_symbol);
...
function BER_cost_d=BER_cost_d_calculation(RX_block,delta,a,Nt,Nr,block_symbol,Ns,K,L,sc_idx,pilot_symbol)
for i=1:Nr
