function [doppler_scalee,cfoe,shifte]=D3Iteration(ald,ahd,alc,ahc,P,u,v,sc_idx,Nt,Nr,Ns,K,L,RX_data,nblk,doppler_scale,pilot_symbol,block_symbol)
...
BER_cost=BER_cost_d_calculation3(RX_block,0,normld,0,normlc,Nt,Nr,block_symbol,Ns,K,L,sc_idx,pilot_symbol,nad,nbd,nac,nbc);
...
while(1)
    ...
    normlc=rec(2,nnnn);
    BER_cost=rec(4,nnnn);
    BER_cost_dd=BER_cost_d_calculation3(RX_block,deltad,normld,0,normlc,Nt,Nr,block_symbol,Ns,K,L,sc_idx,pilot_symbol,nad,nbd,nac,nbc);
    grad(1,nnnn)=2*sqrt(BER_cost)*(sqrt(BER_cost_dd)-sqrt(BER_cost))/(deltad);%*nad
    BER_cost_dc=BER_cost_d_calculation3(RX_block,0,normld,deltac,normlc,Nt,Nr,block_symbol,Ns,K,L,sc_idx,pilot_symbol,nad,nbd,nac,nbc);
...
function BER_cost_d=BER_cost_d_calculation3(RX_block,deltad,ad,deltac,ac,Nt,Nr,block_symbol,Ns,K,L,sc_idx,pilot_symbol,nad,nbd,nac,nbc)
for i=1:Nr
