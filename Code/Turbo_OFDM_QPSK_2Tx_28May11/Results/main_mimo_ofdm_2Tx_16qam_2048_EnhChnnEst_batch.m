...
%
%
function main_mimo_ofdm_2Tx_16qam_2048_EnhChnnEst_batch(factor,L,Chnn_idx,Dist,SNRdB,Niter)
...
Ndata= 45000;           %number of samples in K=2048 segment
if(0)
...
load Data_mod_ofdm_16qam_2048_2Tx.mat  %load Tx symbols
HQAM_TxSym= Data_mod_ofdm_16qam_2048; 
clear Data_mod_ofdm_16qam_2048; 
load Bitstream_ofdm_16qam_2048_2Tx.mat %load Tx bits
if(0)
...
for packet_idx= pkt_idx
    ...
    for nblk= [1:4]
        ...
        Noffset= (1300*2+511+189+1504*24+1300*2+3004)+1300*Nt+511+189+(8+nblk-1)*2528; 
        ...
        for k= 1: Niter
            ...
            for nt= 1: Nt
                ...
                ErrNum(nt,k)= sum(Bitstream_ofdm_16qam_2048(nt,(nblk-1)*Nbit+1: nblk*Nbit)~=Decod_InfoBit);
                ...
                ErrNum1(nt,k)= sum(Bitstream_ofdm_16qam_2048(nt,(nblk-1)*Nbit+1: nblk*Nbit-tblen)~=Decod_InfoBit1);
    ...
    name= ['ErrNum_16QAM_K2048_' packet_name(packet_idx,:)];
...
packet_error_K2048_16QAM= packet_error';
save Results\packet_error_K2048_16QAM packet_error_K2048_16QAM
