...
%
%
function main_mimo_ofdm_2Tx_8psk_1024_EnhChnnEst_batch(factor,L,Chnn_idx,Dist,SNRdB,Niter)
...
if(Dist)
    ...
    %pkt_idx= [1 3 5 6 8 9 10 11 12 13 15];
...
packet_error_K1024_8PSK= packet_error';
save Results\packet_error_K1024_8PSK packet_error_K1024_8PSK
